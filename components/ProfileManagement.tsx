...
import { ArrowUturnLeftIcon, IdentificationIcon, UserCircleIcon, TrashIcon } from './Icons';
...
export const ProfileManagement: React.FC<ProfileManagementProps> = ({ promptGenerator, onBack }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <button onClick={onBack} className="flex items-center gap-2 text-slate-400 hover:text-white transition-colors mb-6 font-semibold">
                <ArrowUturnLeftIcon className="w-5 h-5"/>
                Voltar para o Gerador
            </button>

            <div className="bg-slate-800/50 rounded-2xl p-6 sm:p-8 shadow-2xl shadow-slate-950/50 ring-1 ring-white/10">
                <div className="flex items-center gap-4 mb-8">
                    <UserCircleIcon className="w-16 h-16 text-purple-400"/>
                    <div>
                        <h1 className="text-3xl font-bold text-white">{user.user_metadata?.full_name || 'Gerenciar Perfil'}</h1>
                ...
                {/* Personal Info */}
                <form onSubmit={handleUpdateName} className="mb-8 p-6 bg-slate-900/50 rounded-lg border border-slate-700">
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className="w-full bg-slate-900 border border-slate-600 rounded-lg p-3 text-slate-300 focus:ring-2 focus:ring-purple-500"
                        />
                    </div>
                ...
                {/* Credentials */}
                <form onSubmit={handleUpdateCredentials} className="mb-8 p-6 bg-slate-900/50 rounded-lg border border-slate-700">
                ...
                <div className="p-6 bg-red-900/20 rounded-lg border border-red-500/30">
                    ...
                    <p className="text-slate-400 mb-4">Esta ação não pode ser desfeita. Todos os seus dados, incluindo histórico e presets, serão permanentemente excluídos.</p>
                ...
                message={
                    <>
                        ...
                        <input
                            ...
                            className="w-full mt-2 bg-slate-900 border border-slate-600 rounded-lg p-3 text-slate-300 text-center focus:ring-2 focus:ring-red-500"
                        />
                    </>
                }
